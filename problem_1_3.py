...
## Calculate the error 
linear_regression_r2_score = r2_score(diabetes_ground_truth_value_test, linear_regression_predictions)
print('Accuracy without CV: %.2f'% linear_regression_r2_score)

## Use cross validation to calcualte the mse 
scores = cross_val_score(linear_regression_model, diabetes_feature_data, diabetes_ground_truth_value, cv=5)
print("Accuracy with CV: %0.2f" % scores.mean())
...
## Calculate the error 
ridge_regression_r2_score = r2_score(diabetes_ground_truth_value_test, ridge_regression_predictions)
print('Accuracy without CV: %.2f'% ridge_regression_r2_score)

## Use cross validation to calcualte the mse 
scores = cross_val_score(ridge_regression_model, diabetes_feature_data, diabetes_ground_truth_value, cv=5)
print("Accuracy with CV: %0.2f" % scores.mean())
...
## Create and fit model 
bayesian_ridge_regression_model = linear_model.Ridge()
...
## Calculate the error 
bayesian_ridge_regression_r2_score = r2_score(diabetes_ground_truth_value_test, bayesian_ridge_regression_predictions)
print('Accuracy without CV: %.2f'% bayesian_ridge_regression_r2_score)

## Use cross validation to calcualte the mse 
scores = cross_val_score(bayesian_ridge_regression_model, diabetes_feature_data, diabetes_ground_truth_value, cv=5)
print("Accuracy with CV: %0.2f" % scores.mean())
...
## Calculate the error 
knn_r2_score = r2_score(diabetes_ground_truth_value_test, knn_predictions)
print('Accuracy without CV: %.2f'% knn_r2_score)

## Use cross validation to calcualte the mse 
scores = cross_val_score(knn_model, diabetes_feature_data, diabetes_ground_truth_value, cv=5)
print("Accuracy with CV: %0.2f" % scores.mean())
